...
export default class extends Controller {
  ...
  displayShortBreakMessage() {
    let activity = this.shortBreakActivities[Math.floor(Math.random() * this.shortBreakActivities.length)]

    this.titleTarget.textContent = 'Take a short break, you need it!'
    this.messageBoxTarget.innerHTML = `<h3 class='break-title'>${activity.title}</h3> <img class='break-img' src='${activity.image}'></img> <p class='break-summary'>${activity.description}</p>`
  }
